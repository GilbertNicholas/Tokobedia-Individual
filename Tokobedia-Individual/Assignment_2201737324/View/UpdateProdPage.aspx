<%@ Page Title="" Language="C#" MasterPageFile="~/View/Home.Master" AutoEventWireup="true" CodeBehind="UpdateProdPage.aspx.cs" Inherits="Assignment_2201737324.View.UpdateProdPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h2><p align="center">Update Product Page</p></h2>
    </div>
    <center>
        <table cellpadding="5%">
            <tr>
            ...
            <tr>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4"  ControlToValidate="typeIdProd" runat="server" ErrorMessage="Product type id must be filled" ForeColor="Red"></asp:RequiredFieldValidator>
            </tr>
            <tr>
                <center>
                    <td colspan="2">
            ...
            <tr>
                <td colspan ="2">
                    <center>
                        <asp:Button ID="btnUpdate" runat="server" TabIndex="5" Text="Update" OnClick="updateProduct"/>
                    </center>
                </td>
            </tr>
        </table>
